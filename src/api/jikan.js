...
// Returns up to 5 unique titles, preferring the English title when one
// exists. Falls back to the bundled clip library when Jikan is unreachable
// (e.g. MyAnimeList outages), so autocomplete keeps working offline.
